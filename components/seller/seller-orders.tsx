...
export default async function SellerOrders({ sellerId }: { sellerId: string }) {
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 mb-2">Order #{order.id.slice(0, 8)}</p>
                          <p className="text-sm text-gray-600">
                            Customer: {order.buyer?.full_name} ({order.buyer?.email})
                          </p>
                        </div>
          ...
          <CardContent className="p-12 text-center">
            <div className="max-w-md mx-auto">
              ...
              <Button asChild className="bg-blue-600 hover:bg-blue-700">
                <a href="/sell">List More Products</a>
              </Button>
            </div>
          </CardContent>
        </Card>
